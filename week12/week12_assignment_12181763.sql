...
-- -----------------------------------------------------
-- Schema week12_assignment_12181763
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema week12_assignment_12181763
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `week12_assignment_12181763` DEFAULT CHARACTER SET utf8mb3 ;
USE `week12_assignment_12181763` ;

-- -----------------------------------------------------
-- Table `week12_assignment_12181763`.`building`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `week12_assignment_12181763`.`building` (
  `Id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `week12_assignment_12181763`.`department`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `week12_assignment_12181763`.`department` (
...
-- -----------------------------------------------------
-- Table `week12_assignment_12181763`.`room`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `week12_assignment_12181763`.`room` (
  `Id` INT NOT NULL,
  `Name` VARCHAR(20) NOT NULL,
  ...
  CONSTRAINT `fk_Room_Building`
    FOREIGN KEY (`Bid`)
    REFERENCES `week12_assignment_12181763`.`building` (`Id`),
  CONSTRAINT `fk_Room_Department1`
    FOREIGN KEY (`Did`)
    REFERENCES `week12_assignment_12181763`.`department` (`Id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;


-- -----------------------------------------------------
-- Table `week12_assignment_12181763`.`employee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `week12_assignment_12181763`.`employee` (
  `Id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `week12_assignment_12181763`.`class`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `week12_assignment_12181763`.`class` (
  `Id` INT NOT NULL AUTO_INCREMENT,
  `Name` VARCHAR(20) NOT NULL,
  ...
  CONSTRAINT `fk_Class_Room1`
    FOREIGN KEY (`Rid`)
    REFERENCES `week12_assignment_12181763`.`room` (`Id`),
  CONSTRAINT `fk_class_Employee1`
    FOREIGN KEY (`Eid`)
    REFERENCES `week12_assignment_12181763`.`employee` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;
...
-- -----------------------------------------------------
-- Table `week12_assignment_12181763`.`student`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `week12_assignment_12181763`.`student` (
  `Id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `week12_assignment_12181763`.`take_classes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `week12_assignment_12181763`.`take_classes` (
  `Sid` INT NOT NULL,
  `Cid` INT NOT NULL,
  PRIMARY KEY (`Cid`, `Sid`),
  ...
  CONSTRAINT `fk_Student_has_Class1_Class1`
    FOREIGN KEY (`Cid`)
    REFERENCES `week12_assignment_12181763`.`class` (`Id`),
  CONSTRAINT `fk_Student_has_Class1_Student1`
    FOREIGN KEY (`Sid`)
    REFERENCES `week12_assignment_12181763`.`student` (`Id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;


-- -----------------------------------------------------
-- Table `week12_assignment_12181763`.`Club`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `week12_assignment_12181763`.`Club` (
  `Id` INT NOT NULL AUTO_INCREMENT,
  `Name` VARCHAR(20) NULL,
  `Rid` INT NULL,
  PRIMARY KEY (`Id`),
...
-- -----------------------------------------------------
-- Table `week12_assignment_12181763`.`join_clubs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `week12_assignment_12181763`.`join_clubs` (
  `Cid` INT NOT NULL,
  `Sid` INT NOT NULL,
  PRIMARY KEY (`Cid`, `Sid`),
  ...
  CONSTRAINT `fk_Club_has_student_Club1`
    FOREIGN KEY (`Cid`)
    REFERENCES `week12_assignment_12181763`.`Club` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
INSERT INTO STUDENT
VALUES      (1, '김형석', 'kimhs982@inha.edu', '010-0000-0000', '정보통신공학', '12181763', 3, 'hyungsuk63'),
            (2, '홍길동', 'Hong@inha.edu', '010-1234-5678', '정보통신공학', '12191234', 3, 'gildong34'),
            (3, '김철수', 'Charles@inha.edu', '010-2345-6789', '전기공학', '12202345', 4, 'charles45'),
            (4, '박영희', 'Yeongheui@inha.edu', '010-3456-7890', '전자공학', '12213456', 5, 'yeongheui56'),
            (5, '이민우', 'Minu@inha.edu', '010-4567-8901', '환경공학', '12224567', 1, 'minu67');
